...
pub struct PlayerAlias(#[bitcode(with_serde)] ArrayString<12>);
#[derive(
    Copy, Clone, Debug, Eq, PartialEq, Hash, Ord, PartialOrd, Serialize, Deserialize, Encode, Decode,
)]
pub struct Referrer(#[bitcode(with_serde)] ArrayString<16>);
...
pub struct TeamName(#[bitcode(with_serde)] ArrayString<12>);

#[derive(
    Copy, Clone, Debug, Eq, PartialEq, Hash, Ord, PartialOrd, Serialize, Deserialize, Encode, Decode,
)]
pub struct NickName(#[bitcode(with_serde)] pub ArrayString<12>);

#[derive(
    Copy, Clone, Debug, Eq, PartialEq, Hash, Ord, PartialOrd, Serialize, Deserialize, Encode, Decode,
)]
// TODO: derive macros from candywrapper so that RealmName can go in id.rs
pub struct RealmName(#[bitcode(with_serde)] pub ArrayString<12>);
