...
fn main() {
    ...
    // Create renderer with antialiasing and background color.
    let background_color = [50, 50, 50, 255];
    let antialias = true;
    let mut render_chain = RenderChain::new(background_color, antialias, |r| {
        // Create our layer.
        MyLayer {
